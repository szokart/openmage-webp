 ...
 * Webp helper
 */
class Septsite_Webp_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    {
        if ((bool)Mage::getStoreConfig('advanced/modules_disable_output/Septsite_WebP')) {
            return false;
        }
    ...
    public function hasAlphaTransparency($image)
    {
        ...
        $fileIo = new Septsite_Webp_Lib_Io_File();
